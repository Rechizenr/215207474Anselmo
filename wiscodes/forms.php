...
<body>
    ...
    <p>
        Explanation: The form uses the POST method and the action is set to the same PHP file (`<?php echo $_SERVER['PHP_SELF']; ?>`), which allows the form data to be sent to itself for processing.
    </p>
    <p>
        Handling Input: The `$_POST` superglobal is used to capture the input from the name, lastname, and age fields.
